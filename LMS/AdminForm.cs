...
namespace LMS
{
    public partial class AdminForm : Form
    {
        ...
        public AdminForm(Form previous, Admins admininfo)
        {
            InitializeComponent();
        ...
        {// #TODO light color
            ...
            public static Color color6 = Color.FromArgb(70, 100, 50);
        }
        ...
        private void iconButton5_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new ChangeAdminInfo());
        }
        ...
        private void iconButton6_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new AdminChildForms.Reports());
        }
    }
}
